...
namespace BattleLink.Common.Spawn
{
    ...
    public class BLMultiplayerWarmupComponent : MultiplayerWarmupComponent
    {
        ...
        public new static float TotalWarmupDuration => MultiplayerOptions.OptionType.WarmupTimeLimit.GetIntValue() * 60;
        ...
        public WarmupStates WarmupState
        {
            ...
            set
            {
                ...
                FieldInfo fMission = typeof(MultiplayerWarmupComponent).GetField("_warmupState", BindingFlags.NonPublic | BindingFlags.Instance);
                fMission.SetValue(this, value);

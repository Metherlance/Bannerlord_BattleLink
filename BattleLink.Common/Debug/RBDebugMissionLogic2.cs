...
{
    public class RBDebugMissionLogic2 : MissionLogic
    {
        ...
        {
            MBDebug.Print("RBDebugMissionLogic - OnAgentHit", 0, DebugColor.Cyan);
        }

        public override void OnScoreHit(Agent affectedAgent, Agent affectorAgent, WeaponComponentData attackerWeapon, bool isBlocked, bool isSiegeEngineHit, in Blow blow, in AttackCollisionData collisionData, float damagedHp, float hitDistance, float shotDifficulty)
        {
            MBDebug.Print("RBDebugMissionLogic - OnScoreHit", 0, DebugColor.Cyan);
        }
        ...
        {
            MBDebug.Print("RBDebugMissionLogic - OnAgentRemoved", 0, DebugColor.Cyan);
        }
        ...
        {
            MBDebug.Print("RBDebugMissionLogic - OnGetAgentState", 0, DebugColor.Cyan);
        }
        ...
        {
            MBDebug.Print("RBDebugMissionLogic - OnRegisterBlow", 0, DebugColor.Cyan);
        }
